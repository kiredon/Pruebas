...
<html>
<head>
<title>MUS - Tipo de Vivienda</title>

<script
	src="${pageContext.servletContext.contextPath}/js/admin/tipoVivienda.js"></script>
</head>
<body>

	<div class="ui stackable grid container">

		<div class="sixteen wide column" ng-controller="tipoViviendaController">
			<h1>Tipo de Vivienda</h1>
			<div class="ui divider"></div>

			<a href="#" id="formulario"
				class="small ui primary formulario button "
				ng-click="insertarTipoVivienda()"> Agregar nuevo elemento </a>
			...
			<table class="ui celled blue striped table">
				...
				<tbody>
					<tr ng-repeat="(key,value) in tipoViviendaList">
						<td>{{value.nombreTipoVivienda}}</td>
						...
						<td><a href="#"><i class="edit icon" title="Editar"
								ng-click="editarTipoVivienda(value)"></i></a> <a href="#"
							ng-click="borrarTipoVivienda(value.idTipoVivienda,value.status,value.nombreTipoVivienda)"><i
		...
		<div class="ui modal" id="editarModal"
			...
			<div class="header">Agregar / Editar Tipo de Vivienda</div>
			<div class="content" ng-form="formTipoVivienda">

				<div class="ui form segment">

					<div class="one required field">
						<div class="field"
							ng-class="validate(formTipoVivienda.nombreTipoVivienda) ? 'error':''">
							<label>Tipo de Vivienda </label> <input placeholder="Tipo de Vivienda"
								type="text" name="nombreTipoVivienda"
								ng-model="tipoVivienda.nombreTipoVivienda" required maxlength="150">
							<span ng-show="validate(formTipoVivienda.nombreTipoVivienda)">
					...
					<div class="three fields">
						<div class="disabled field">
							<label>Id</label> <input placeholder="ID" type="text"
								disabled="disabled" ng-model="tipoVivienda.idTipoVivienda">
						</div>
						<div class="disabled field">
							<label>Fecha Creación</label> {{tipoVivienda.fechaCreacion |
							date:'yyyy-MM-dd HH:mm:ss'}}

						</div>
						<div class="disabled field">
							<label>Fecha Edición</label> {{tipoVivienda.fechaEdicion |
							date:'yyyy-MM-dd HH:mm:ss'}}
						</div>
					</div>
				...
				<div class="actions">
					<button class="ui primary button ok"
						ng-disabled="formTipoVivienda.$invalid">Guardar</button>
				</div>
			</div>
