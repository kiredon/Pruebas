...
<html>
<head>
<title>MUS - Tipo de Almacén</title>

<script
	src="${pageContext.servletContext.contextPath}/js/admin/tipoAlmacen.js"></script>
</head>
<body>

	<div class="ui stackable grid container">

		<div class="sixteen wide column" ng-controller="tipoAlmacenController">
			<h1>Tipo de Almacén</h1>
			<div class="ui divider"></div>

			<a href="#" id="formulario"
				class="small ui primary formulario button "
				ng-click="insertarTipoAlmacen()"> Agregar nuevo elemento </a>
			...
			<table class="ui celled blue striped table">
				...
				<tbody>
					<tr ng-repeat="(key,value) in tipoAlmacenList">
						<td>{{value.nombreTipoAlmacen}}</td>
						...
						<td><a href="#"><i class="edit icon" title="Editar"
								ng-click="editarTipoAlmacen(value)"></i></a> <a href="#"
							ng-click="borrarTipoAlmacen(value.idTipoAlmacen,value.status,value.nombreTipoAlmacen)"><i
		...
		<div class="ui modal" id="editarModal"
			...
			<div class="header">Agregar / Editar Tipo de Almacén</div>
			<div class="content" ng-form="formTipoAlmacen">

				<div class="ui form segment">

					<div class="one required fields">
						<div class="field"
							ng-class="validate(formTipoAlmacen.nombreTipoAlmacen) ? 'error':''">
							<label>Tipo de Almacén </label> <input placeholder="Tipo de Almacen"
								type="text" name="nombreTipoAlmacen"
								ng-model="tipoAlmacen.nombreTipoAlmacen" required maxlength="50">
							<span ng-show="validate(formTipoAlmacen.nombreTipoAlmacen)">
					...
					<div class="three fields">
						<div class="disabled field">
							<label>Id</label> <input placeholder="ID" type="text"
								disabled="disabled" ng-model="tipoAlmacen.idTipoAlmacen">
						</div>
						<div class="disabled field">
							<label>Fecha Creación</label> {{tipoAlmacen.fechaCreacion |
							date:'yyyy-MM-dd HH:mm:ss'}}

						</div>
						<div class="disabled field">
							<label>Fecha Edición</label> {{tipoAlmacen.fechaEdicion |
							date:'yyyy-MM-dd HH:mm:ss'}}
						</div>
					</div>
				...
				<div class="actions">
					<button class="ui primary button ok"
						ng-disabled="formTipoAlmacen.$invalid">Guardar</button>
				</div>
			</div>
