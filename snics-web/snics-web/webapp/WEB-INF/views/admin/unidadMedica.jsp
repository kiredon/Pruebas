...
<body>
	...
	<div class="ui stackable grid container">
		...
		<div class="ui modal" id="editarModal"
			...
			<div class="header">Agregar / Editar unidad médica</div>
				...
				<div class="ui form segment">
					...
					<div class="one required fields">
						<div class="field"
							...
							<label>Unidad Médica </label> <input placeholder="Unidad Médica"
					...
					<div class="three fields">
						...
						<div class="disabled field">
							<label>Fecha Creación</label> {{unidadMedica.fechaCreacion |
							date:'yyyy-MM-dd HH:mm:ss'}}

						</div>
						<div class="disabled field">
							<label>Fecha Edición</label> {{unidadMedica.fechaEdicion |
							date:'yyyy-MM-dd HH:mm:ss'}}
						</div>
					</div>
