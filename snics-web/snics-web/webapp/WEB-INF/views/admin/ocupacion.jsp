...
<body>
	...
	<div class="ui stackable grid container">
		...
		<div class="ui modal" id="editarModal"
			...
			<div class="header">Agregar / Editar Ocupación</div>
				...
				<div class="ui form segment">
					...
					<div class="one required field">
						<div class="field"
							...
							<label>Ocupación </label> <input placeholder="Ocupacion"
								type="text" name="nombre ocupación"
					...
					<div class="three fields">
						...
						<div class="disabled field">
							<label>Fecha Creación</label> {{ocupacion.fechaCreacion |
							date:'yyyy-MM-dd HH:mm:ss'}}

						</div>
						<div class="disabled field">
							<label>Fecha Edición</label> {{ocupacion.fechaEdicion |
							date:'yyyy-MM-dd HH:mm:ss'}}
						</div>
					</div>
