...
<html>
<head>
<title>MUS - Presentación Entrada / Salida de Medicamentos</title>
...
<body>
	...
	<div class="ui stackable grid container">
		...
		<div class="sixteen wide column" ng-controller="presentacionController">
			<h1>Presentación Entrada / Salida de Medicamentos</h1>
		...
		<div class="ui modal" id="editarModal"
			...
			<div class="header">Agregar / Editar Presentación</div>
				...
				<div class="ui form segment">
					...
					<div class="one required field">
						<div class="field"
							...
							<label>Presentación </label> <input placeholder="Presentacion"
					...
					<div class="three fields">
						...
						<div class="disabled field">
							<label>Fecha Creación</label> {{presentacion.fechaCreacion |
							date:'yyyy-MM-dd HH:mm:ss'}}

						</div>
						<div class="disabled field">
							<label>Fecha Edición</label> {{presentacion.fechaEdicion |
							date:'yyyy-MM-dd HH:mm:ss'}}
						</div>
					</div>
