...
<html>
<head>
<title>MUS - Prescripciones CEDIME</title>
			...
			<table class="ui celled blue striped table">
				...
				<tbody>
					<tr ng-repeat="(key,value) in medicamentoList">
						...
						<td></i></a>
							<a href="#"><i class="unhide icon" title="Ver"
								ng-click="verMedicamento(value)"></i></a>
								<a href="#"><i class="edit icon" title="Editar"
							...
							ng-click="borrarMedicamento(value.idMedicamento,value.status,value.nombreCorto)"><i
								...
								ng-class="value.status ? 'toggle on icon':'toggle off icon'"></td>
					</tr>
			...
			<div class="content" ng-form="formMedicamento">
				...
				<div class="ui form segment">
						...
						<div class="field">
							<div class="required field"
								...
								<label>Clave Institucional </label> <input class="verEditar"
									placeholder="Clave Institucional" type="text" name="clave"
									ng-model="medicamento.claveInstitucional" required
									maxlength="15"> <span
							...
							<div class="required field"
								...
								<label>Nombre corto </label> <input placeholder="Nombre corto" class="verEditar"
									type="text" ng-model="medicamento.nombreCorto" required
									maxlength="100" name="nombreCorto"> <span
									ng-show="validate(formMedicamento.nombreCorto)">El
									nombre corto es requerido </span>
							</div>

							<div class="required field">
								<label>Nombre Sustancia Activa </label> <select id="seleccion" class="verEditarSelect"
									ng-model="medicamento.idCatSal" required>
					...
					<div class="field"
						...
						<label>Nombre largo</label> <input placeholder="Nombre largo" class="verEditar"
							type="text" ng-model="medicamento.nombreLargo" maxlength="200"
							name="nombreLargo">
					</div>
					<div class="field"
					...
					<div class="field"
						...
						<label>Laboratorio</label> <input placeholder="Laboratorio" class="verEditar"
							type="text" ng-model="medicamento.laboratorio" maxlength="50">
					</div>
					<div class="three required fields">
						<div class="field">
							<label>Presentación entrada </label> <select id="seleccion" class="verEditarSelect"
						...
						<div class="field">
							<label>Presentación salida </label> <select id="seleccion" class="verEditarSelect"
					...
					<div class="three fields">
						<div class=" required field">
							<label>Categoría medicamento </label> <select id="seleccion" class="verEditarSelect"
						...
						<div class="required field">
							<label>Subcategoría medicamento </label> <select id="seleccion" class="verEditarSelect"
					...
					<div class="three requerid fields">
						...
						<div class="field"
							...
							<label>Mínimo</label> <input placeholder="Mínimo" type="number" class="verEditar"
								id="minimo" ng-model="medicamento.minimo">
						</div>
						<div class="field"
							ng-class="validate(formMedicamento.reorden) ? 'error':''">
							<label>Reorden</label> <input placeholder="Reorden" type="number" class="verEditar"
								id="reorden" ng-model="medicamento.reorden">
						</div>
						<div class="field"
							ng-class="validate(formMedicamento.maximo) ? 'error':''">
							<label>Máximo</label> <input placeholder="Máximo" type="number" class="verEditar"
								id="maximo" ng-model="medicamento.maximo">
						</div>
					</div>
					<div class="three fields">
